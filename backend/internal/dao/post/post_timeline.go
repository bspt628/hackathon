...
func (dao *PostDAO) GetFollowedUsersPosts(ctx context.Context, userID string, limit int32) ([]sqlc.GetFollowedUsersPostsRow, error) {
    return dao.queries.GetFollowedUsersPosts(ctx, sqlc.GetFollowedUsersPostsParams{
